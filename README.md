...
These are prone to failure, and hard to find. It's best to use a mod to use a standard 34-pin interface. Then a floppy or even Gotek USB floppy emulator (pictured):
